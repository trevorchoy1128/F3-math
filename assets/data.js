...
// 英文版本：titleEn、en（課題英文名）、descEn
// status: "planned" = 籌備中, "draft" = 製作中, "ready" = 已完成
window.SITE = {
  title: "中三數學學習站",
  titleEn: "S3 Maths Hub",
  subtitle: "Form 3 Mathematics",
};

window.STRANDS = [
  { id: "na",  name: "數與代數",           en: "Number and Algebra" },
  { id: "mss", name: "度量、圖形與空間",   en: "Measures, Shape and Space" },
...
window.TOPICS = [
  {
    ...
    descEn: "Place value, decimal and binary, converting binary numbers to decimal",
  ...
  },
  {
    ...
    desc: "零指數、負整數指數、指數定律",
    descEn: "Zero index, negative integral indices, laws of indices",
  ...
  },
  {
    ...
    descEn: "Writing very large or very small numbers as a × 10ⁿ",
  ...
  },
  {
    ...
    descEn: "Taking out common factors, using identities, cross method",
  ...
  },
  {
    ...
    descEn: "Compound interest, growth and depreciation, successive percentage changes",
  ...
  },
  {
    ...
    descEn: "Surface areas and volumes of pyramids, cones and spheres",
  ...
  },
  {
    ...
    desc: "相似的條件、對應邊的比",
    descEn: "Conditions for similar triangles, ratios of corresponding sides",
  ...
  },
  {
    ...
    desc: "正弦、餘弦、正切；仰角與俯角",
    descEn: "Sine, cosine and tangent; angles of elevation and depression",
  ...
  },
  {
    ...
    descEn: "Parallelograms, mid-point theorem, intercept theorem",
  ...
  },
  {
    ...
    desc: "內心、外心、形心、垂心",
    descEn: "Incentre, circumcentre, centroid and orthocentre",
  ...
  },
  {
    ...
    desc: "距離公式、斜率、中點及內分點",
    descEn: "Distance formula, slope, mid-point and point of division",
  ...
  },
  {
    ...
    descEn: "Theoretical and experimental probability, listing all possible outcomes",
  ...
  },
  {
    ...
    descEn: "Mean, median, mode and weighted mean",
    keywords: ["平均數", "中位數", "眾數", "加權", "mean", "median", "mode", "average"],
  },
];

window.STATUS_LABEL = { planned: "籌備中", draft: "製作中", ready: "已完成" };
window.STATUS_LABEL_EN = { planned: "Planned", draft: "In progress", ready: "Ready" };
